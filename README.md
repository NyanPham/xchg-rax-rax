...
The xadd instruction exchange sthe values of rax and rdx, then adds the values and stores the sum in rax. In each iteration, the latest sum becomes the previous number for the next addition (by exchanging the values). 
